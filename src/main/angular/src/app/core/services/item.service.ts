...
export class ItemService {
  ...
  getAllItems(): Observable<Array<Item>>{
    return this.httpClient.get<Array<Item>>(MAIN_URL + ITEM_URL + '/get-all');
  }
  ...
  updateItem(item: Item): Observable<boolean>{
    return this.httpClient.post<boolean>(MAIN_URL + ITEM_URL + '/update', item);
  }

  deleteItem(item: Item): Observable<boolean>{
    return this.httpClient.post<boolean>(MAIN_URL + ITEM_URL + '/delete', item.code);
  }
}
